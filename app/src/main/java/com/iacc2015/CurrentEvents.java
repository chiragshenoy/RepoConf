...
//        setSupportActionBar(toolbar);
        ...
        //Jan 4th
        if (current_time.compareTo("12:06 08:00:00") > 0 && current_time.compareTo("12:06 09:30:00") < 0) {
            event_going_on = true;
            ...
            title.setText("Registration with Breakfast");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("8:00 am - 9.30 am");
        ...
        //Breakfast
        if (current_time.compareTo("12:06 09:30:00") > 0 && current_time.compareTo("12:06 10:45:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Inauguration");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("09:30 am - 10:45 am");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }

        //Transportation
        if (current_time.compareTo("12:06 10:45:00") > 0 && current_time.compareTo("12:06 11:30:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Poster Session and Tea Break");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("10:45am - 11.30am");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("");
            main_layout.addView(v1);
        }

//        if (current_time.compareTo("11:06 22:30:00") > 0 && current_time.compareTo("12:06 12:10:00") < 0) {

        if (current_time.compareTo("12:06 11:30:00") > 0 && current_time.compareTo("12:06 12:10:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Talk by Roger");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("11.30am - 12.10pm");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }

        if (current_time.compareTo("12:06 12:10:00") > 0 && current_time.compareTo("12:06 12:50:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Talk by Dr. Raja Datta");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("12.10pm - 12.50pm");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }

        if (current_time.compareTo("12:06 12:50:00") > 0 && current_time.compareTo("12:06 13:30:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Talk by Sri. Vikas Mathur");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("12.50pm - 1.30pm");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }
        ...
        if (current_time.compareTo("12:06 13:30:00") > 0 && current_time.compareTo("12:06 14:30:00") < 0) {
            event_going_on = true;
        ...
        //Day 1 Workshops
        //Jan 5th
        String s = "12:06 14:30:00";
        String g = "12:06 17:30:00";
        ...
        if (current_time.compareTo("13:06 09:00:00") > 0 && current_time.compareTo("13:06 09:45:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Talk by Dr. Seeram");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("09.00am - 09.45am");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }

        if (current_time.compareTo("13:06 09:45:00") > 0 && current_time.compareTo("13:06 10:20:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Talk by Dr. Biplab Sikdar");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("09.45am - 10.20am");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }

        if (current_time.compareTo("13:06 10:20:00") > 0 && current_time.compareTo("13:06 11:00:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Talk by Dr. Y.V.S. Lakshmi");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("10.20pm - 11.00am");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }
        ...
        if (current_time.compareTo("13:06 11:00:00") > 0 && current_time.compareTo("13:06 11:40:00") < 0) {
            event_going_on = true;
            ...
            title.setText("Poster Session and Tea Break");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("11:00am - 11.40am");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("");
            main_layout.addView(v1);
        }

        if (current_time.compareTo("13:06 11:40:00") > 0 && current_time.compareTo("13:06 12:25:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Talk by Dr. B.V.R. Chowdari");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("11:40am - 12.25pm");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }

        if (current_time.compareTo("13:06 12:30:00") > 0 && current_time.compareTo("13:06 13:30:00") < 0) {
            event_going_on = true;
            ...
            View v1 = vi.inflate(R.layout.event_layout, null);
            TextView title = (TextView) v1.findViewById(R.id.title);
            title.setText("Dr. Hari Krishna Garg");
            TextView when = (TextView) v1.findViewById(R.id.when);
            when.setText("12:30pm - 01.30pm");
            TextView where = (TextView) v1.findViewById(R.id.where);
            where.setText("Indoor Stadium");
            main_layout.addView(v1);
        }
        ...
        if (current_time.compareTo("13:06 13:30:00") > 0 && current_time.compareTo("13:06 14:30:00") < 0) {
            event_going_on = true;
...
//        String s1 = "11:06 01:20:00";
//        String g1 = "11:06 02:30:00";


        String s1 = "13:06 14:30:00";
        String g1 = "13:06 17:30:00";

        if (current_time.compareTo(s1) > 0 && current_time.compareTo(g1) < 0) {
            Toast.makeText(this, "Events going on", Toast.LENGTH_LONG).show();
            event_going_on = true;
            //
            LayoutInflater vi = (LayoutInflater) getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
